          ...
          <div className="p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button 
                type="submit"
                disabled={isLoading}
                className="w-full py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-2xl font-black shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/40 hover:scale-[1.02] active:scale-95 transition-all uppercase tracking-wider mt-4 disabled:opacity-70 disabled:hover:scale-100"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <button 
                ...
                className="flex items-center justify-center gap-3 px-4 py-3 border-2 border-slate-50 rounded-2xl hover:bg-slate-50 transition-colors font-bold text-slate-600 text-sm active:scale-95"
              >
