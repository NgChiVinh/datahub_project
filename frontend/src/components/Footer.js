  ...
  const menuItems = [
    {
      ...
      links: [
        ...
        { name: "Đồ án sinh viên", href: "/projects", soon: true },
    ...
    },
    {
      title: "Cộng đồng",
      links: [
        { name: "Bảng xếp hạng", href: "/leaderboard", soon: true },
        { name: "Đóng góp tài liệu", href: "/upload" },
        { name: "Câu hỏi thường gặp", href: "/faq", soon: true },
        { name: "Liên hệ hỗ trợ", href: "/contact", soon: true },
      ],
    },
    {
      title: "Chính sách",
      links: [
        { name: "Điều khoản sử dụng", href: "/terms", soon: true },
        { name: "Chính sách bảo mật", href: "/privacy", soon: true },
        { name: "Quy định bản quyền", href: "/copyright", soon: true },
      ],
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-20 mb-24">
          ...
          <div className="max-w-sm flex flex-col gap-8">
            ...
            <div className="flex items-center gap-5">
              <button type="button" aria-label="Facebook (sắp ra mắt)" className="group">
              ...
              <button type="button" aria-label="GitHub (sắp ra mắt)" className="group">
              ...
              <button type="button" aria-label="Liên hệ (sắp ra mắt)" className="group">
                ...
                <ul className="flex flex-col gap-4">
                  {item.links.map((link) => (
                    <li key={link.name}>
                      {link.soon ? (
                        <span
                          className="text-sm font-semibold text-slate-300 cursor-default inline-flex items-center gap-2 w-fit"
