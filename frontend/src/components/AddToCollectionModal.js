...
export default function AddToCollectionModal({ isOpen, onClose, materialId }) {
  ...
  const handleCreateSuccess = (newCol) => {
    ...
    // Sau khi tạo xong có thể tự động thêm vào luôn hoặc để người dùng chọn
    toast.success("Đã tạo bộ sưu tập mới. Hãy chọn nó để thêm tài liệu!");
  };
          ...
          <div className="p-8 md:p-10">
            ...
            <div className="mb-6">
               <button 
                 ...
                 className="w-full flex items-center justify-center gap-2 py-4 border-2 border-dashed border-slate-200 rounded-2xl text-[10px] font-black uppercase tracking-widest text-slate-400 hover:border-emerald-500 hover:text-emerald-500 transition-all"
               >
