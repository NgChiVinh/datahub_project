      ...
      <section className="bg-slate-50/50 border-b border-slate-100 py-12">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <Link href="/upload" className="inline-flex items-center gap-2 px-6 py-3.5 bg-primary text-white rounded-2xl text-xs font-bold hover:brightness-110 transition-all active:scale-95 shadow-lg shadow-emerald-100">
